...
public final class RelationshipTraits {
    private static final RelationshipTraits DEFAULTS = new RelationshipTraits(
        false, Survival.REMOVE, Survival.REMOVE, OnDeleteTarget.REMOVE, SourceRetention.RELEASE);
    ...
    public RelationshipTraits exclusive() {
        return new RelationshipTraits(true, transfer, temporaryDeactivation, onDeleteTarget, sourceRetention);
    }

    @Nonnull
    public RelationshipTraits onDeleteTarget(OnDeleteTarget onDeleteTarget) {
        return new RelationshipTraits(exclusive, transfer, temporaryDeactivation,
    ...
    public RelationshipTraits retainOnTransfer() {
        return new RelationshipTraits(exclusive, Survival.RETAIN, temporaryDeactivation, onDeleteTarget,
            sourceRetention);
    }
    ...
    public RelationshipTraits retainOnDeactivation() {
        return new RelationshipTraits(exclusive, transfer, Survival.RETAIN, onDeleteTarget, sourceRetention);
    }

    /// Keeps the empty source storage after the final link of a source is removed.
    @Nonnull
    public RelationshipTraits retainSourceStorage() {
        return new RelationshipTraits(exclusive, transfer, temporaryDeactivation, onDeleteTarget,
